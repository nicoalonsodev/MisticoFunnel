        ...
        <div className="flex justify-center items-start py-20 w-full lg:w-2/3 gap-6">
          <div className="flex flex-col justify-start items-start space-y-6">
            ...
            <h1 className="text-xl text-yellow-700 font-semibold">
              Su pago fue denegado
            </h1>
            <p>
              Lamentablemente parece que Mercado Pago denegó su acreditación,
              por lo que le pedimos que se comunique con su equipo para
            ...
            <p>
              Por favor, si necesita realizar su compra le pedimos que vuelva a
              cargar los productos en su carrito y efectúe el pago con su medio
              de confianza.
            </p>
          </div>
        </div>
