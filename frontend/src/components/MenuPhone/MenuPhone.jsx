  ...
  return (
    ...
    >
      ...
      <div className="w-full py-2 flex justify-between">
        <h1 className=" text-gray-800 text-3xl font-sans-600">
          Carrito Promocional
        </h1>
        <div className="">
          <FaTimes
      ...
      <div>
        <p className="text-yellow-600 mb-2 text-center text-balance font-semibold my-2">
          ¡Aprovecha esta oferta exclusiva! Solo en este enlace, obtén tu
          segundo jean con un 30% de descuento.
        </p>
      </div>
      ...
      <a
      href='/payment'
      className='w-full rounded-xl bg-yellow-700 hover:bg-yellow-500 text-xl text-gray-100 flex justify-center items-center py-2'><p>{` 👉🏻 IR A PAGAR ${products.length === 1 ? "$60,000" : "$102,000"}`}</p></a>
